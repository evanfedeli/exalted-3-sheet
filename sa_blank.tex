...
\newcommand{\logo}{\includegraphics[scale=0.3]{sa_logo.png}}
...
\newcommand{\ptwelve}{$\square\square\square\square\square\square\square\square\square\square\square\square$}
...
\begin{document}
  %%%
  \sheetheader{\spacer}{Name:\tab Age:\tab Player:\tab Vice:\spacer}
  %%%
  ...
  % \s - supernal ability
  \begin{multicols}{3}
    \columnheader{Mental (-3 if unskilled)}
    \score{Academics}{\0}
    \score{Chi Focus}{\0}
    \score{Computer}{\0}
    \score{Crafts}{\0}
    ...
    \score{Science}{\0}
    %%%
    \columnheader{Physical (-1 if unskilled)}
    \score{Athletics}{\0}
    \score{Brawl}{\0}
    \score{Drive}{\0}
    \score{Firearms}{\0}
    ...
    \score{Weaponry}{\0}
    %%%
    \columnheader{Social (-1 if unskilled)}
    \score{Animal Ken}{\0}
    \score{Empathy}{\0}
    \score{Expression}{\0}
    \score{Intimidation}{\0}
    \score{Persuasion}{\0}
    \score{Socialize}{\0}
    \score{Streetwise}{\0}
    \score{Subterfuge}{\0}
...
%
  ...
  \begin{multicols}{4}
    ...
    \score{}{\0}
    \nextcolumn
    \columnheader{Non-Human Qualities}
    \score{}{\0}
    \score{}{\0}
    \score{}{\0}
    \score{}{\0}
  ...
  \sectionheader{Stuff}
  \begin{multicols}{4}
    \columnheader{Weapon Attack}
    \property{}{}
    \property{}{}
    \property{}{}
    \property{}{}
    \nextcolumn
    \columnheader{Dice Mod.}
    \property{}{}
    \property{}{}
    \property{}{}
    \property{}{}
    \nextcolumn
    \columnheader{Range/Clip}
    \property{}{}
    \property{}{}
    \property{}{}
    \property{}{}
  ...
  \begin{multicols}{3}
    \columnheader{Advantages}
    \property{Size}{}
    \property{Speed}{}
    \property{Defense}{}
    \property{Armor}{}
    \property{Initiative Mod}{}
    \property{Experience}{}
    \blankline
    \nextcolumn
    \blankline
